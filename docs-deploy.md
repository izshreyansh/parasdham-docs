# Deploy Docs Site
This is a short guide on how to deploy this documentation site on any serverless hosting service.

### Deploy on local
Running the documentation site on local environment is as easy at running these 2 commands:
...
![github pages](./images/deploy-github-pages.png)
